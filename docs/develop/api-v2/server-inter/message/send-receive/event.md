...
| member_role | string | 消息发送者在群内的身份，枚举：owner、admin、member |
| bot | bool | 是否是机器人 |
...
<table>
	...
	<tr>
    <td>事件类型</td>
    <td>GROUP_MESSAGE_CREATE</td>
	</tr>
	<tr>
    <td>触发场景</td>
    <td>群主设定允许机器人接收群内全部消息时，机器人接收群内所有成员发言</td>
	</tr>
  <tr>
    <td>权限要求</td>
    <td>群主授权</td>
